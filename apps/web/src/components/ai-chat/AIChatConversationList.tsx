...
export type AIChatConversation = SidebarConversation;
...
export function AIChatConversationList({ conversations, activeId, onSelect, onNew, onDelete, onRename, loading }: Props) {
  return (
    <div className="flex h-full w-64 shrink-0 flex-col"
      ...
      <div className="px-4 py-3 text-center text-[10px]"
